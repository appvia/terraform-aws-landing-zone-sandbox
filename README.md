...
| <a name="input_caretaker_log_retention_in_days"></a> [caretaker\_log\_retention\_in\_days](#input\_caretaker\_log\_retention\_in\_days) | The number of days to retain the logs for the caretaker | `number` | `15` | no |
| <a name="input_caretaker_namespace"></a> [caretaker\_namespace](#input\_caretaker\_namespace) | The namespace to provision the caretaker in | `string` | `"default"` | no |
| <a name="input_caretaker_schedule_expression"></a> [caretaker\_schedule\_expression](#input\_caretaker\_schedule\_expression) | The schedule expression to run the caretaker | `string` | `"rate(48 hours)"` | no |
...
| <a name="input_enable_caretaker"></a> [enable\_caretaker](#input\_enable\_caretaker) | A flag indicating if the scheduled cleaner should be enabled | `bool` | `true` | no |
| <a name="input_git_repository"></a> [git\_repository](#input\_git\_repository) | The git repository to clone the terraform modules from | `string` | `null` | no |
